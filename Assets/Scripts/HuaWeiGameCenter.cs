...
public class HuaWeiGameCenter : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        {
            Message1 = "ToGame";
            HolagamesSDK.getInstance().loginGameRole("create", "roleId=10278&roleName=阳光灬E社&roleLevel=1&zoneId=androids26&zoneName=混服22服 幽灵杀手&roleCTime=1481543091&roleLevelMTime=1481547775&vip=0");
        }
...
#elif WDJ
            HolagamesSDK.getInstance().Pay("1_1_10001_xxx_1_1_60钻石");//WDJ diamond, zoneid, guid, name, level, paytype, ProductName
#elif LENOVO
